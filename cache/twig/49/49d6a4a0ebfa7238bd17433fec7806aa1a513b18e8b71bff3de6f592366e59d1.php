...
/* config.html.twig */
class __TwigTemplate_a2741db040bd0684dce32e0bf7c5403c7d4561bd1fbc7ecd68f916e91e897f5c extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 6
        $context["tab_title_string"] = ("PLUGIN_ADMIN." . twig_upper_filter($this->env, (isset($context["config_slug"]) ? $context["config_slug"] : null)));
        // line 7
        $context["tab_title"] = ((($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter((isset($context["tab_title_string"]) ? $context["tab_title_string"] : null)) == (isset($context["tab_title_string"]) ? $context["tab_title_string"] : null))) ? (twig_capitalize_string_filter($this->env, (isset($context["config_slug"]) ? $context["config_slug"] : null))) : ($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter((isset($context["tab_title_string"]) ? $context["tab_title_string"] : null))));
        // line 8
        $context["title"] = (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.CONFIGURATION") . ": ") . (isset($context["tab_title"]) ? $context["tab_title"] : null));
        // line 10
...
";
    ...
    public function block_titlebar($context, array $blocks = array())
    {
        ...
        ";
        // line 26
        if ($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "file", array()), "filename", array())) {
            // line 27
    ...
    <h1><i class=\"fa fa-fw fa-wrench\"></i> ";
        ...
        echo " - ";
        echo twig_escape_filter($this->env, (isset($context["tab_title"]) ? $context["tab_title"] : null), "html", null, true);
        echo "</h1>
";
    }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["configuration"]) {
            ...
            if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => ("admin.configuration_" . $context["configuration"]), 1 => "admin.super"))) {
                ...
                if ((((($context["configuration"] != "system") && ($context["configuration"] != "site")) &&  !$this->getAttribute($this->getAttribute((isset($context["current_blueprints"]) ? $context["current_blueprints"] : null), "form", array()), "hidden", array())) && ( !twig_test_empty($this->getAttribute($this->getAttribute((isset($context["current_blueprints"]) ? $context["current_blueprints"] : null), "form", array()), "fields", array())) ||  !twig_test_empty($this->getAttribute($this->getAttribute((isset($context["current_blueprints"]) ? $context["current_blueprints"] : null), "form", array()), "field", array()))))) {
                    ...
                    // line 59
                    echo "                            <span>";
                    echo twig_escape_filter($this->env, ((($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter((isset($context["configuration_string"]) ? $context["configuration_string"] : null)) == (isset($context["configuration_string"]) ? $context["configuration_string"] : null))) ? (twig_capitalize_string_filter($this->env, $context["configuration"])) : ($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter((isset($context["configuration_string"]) ? $context["configuration_string"] : null)))), "html", null, true);
                    echo "</span>
                        </a>
                    ";
                }
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        ";
                ...
                // line 82
                echo "            ";
                $this->loadTemplate("partials/blueprints.html.twig", "config.html.twig", 82)->display(array_merge($context, array("blueprints" => $this->getAttribute((isset($context["data"]) ? $context["data"] : null), "blueprints", array()), "data" => (isset($context["data"]) ? $context["data"] : null))));
                // line 83
                echo "        ";
            }
            // line 84
...
{% endblock %}
", "config.html.twig", "/var/www/html/grav-admin/user/plugins/admin/themes/grav/templates/config.html.twig");
    }
}
